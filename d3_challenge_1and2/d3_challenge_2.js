...
// circle elements in the svg with the function data().
...
sorted = data2.sort(function(a, b){return a.x-b.x})
...
var categories = ['cat','dog','bunny','pig','owl','frog','hen'];
var bar_p = 10;
...
var y = d3.scale.linear()
	.domain([0,d3.max(data3,function(d){return d.y;})])
	.range([h,0]);
...
var g = svg.selectAll('g')
	...
	.attr('transform',function(d,i){
		return 'translate('+x(d.category)+','+y(d.y)+')'
	})
